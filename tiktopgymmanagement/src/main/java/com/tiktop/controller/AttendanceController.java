...
public class AttendanceController {
	...
	public ModelAndView checkBodyMeasurement(@Valid @ModelAttribute("attendance") Attendance attendance,BindingResult bindingResult,HttpSession session) throws ParseException {
		String login = (String)session.getAttribute("currentUser");
		Member member = memberService.findMemberByLogin(login);
	...
	public String saveAttendance(@Valid @ModelAttribute("attendance") Attendance attendance, BindingResult bindingResult,
			Model model) {
		if (bindingResult.hasErrors()) {
			return "admin/addAttendance";
		}
